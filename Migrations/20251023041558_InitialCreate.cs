        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Citas_Usuarios_ContadorId",
                        column: x => x.ContadorId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Citas_Usuarios_ContribuyenteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documentos_Usuarios_ContribuyenteId",
                        column: x => x.ContribuyenteId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Citas_ContadorId",
                table: "Citas",
                column: "ContadorId");

            migrationBuilder.CreateIndex(
                name: "IX_Citas_ContribuyenteId",
                table: "Citas",
                column: "ContribuyenteId");

            migrationBuilder.CreateIndex(
                name: "IX_Documentos_ContribuyenteId",
                table: "Documentos",
                column: "ContribuyenteId");
        }
